...
//when passing std::array to a funbction
...
void test1(){
    std::cout << "\nTest1================================" << std::endl;
    std::array <int, 5> arr1 {1,2,3,4,5};    // dounble {{ }} if c++11
    std::array <int ,5> arr2;

    display(arr1);  
    display(arr2);   // Elements are not initialized contains garbage
...
void test8(){
    ...
    std::array <int, 10> arr1 {1,2,3,4,5,3,3,3,5,3};
...
void test9(){
    ...
    //find how manby numbers are in between  10 and 200 
